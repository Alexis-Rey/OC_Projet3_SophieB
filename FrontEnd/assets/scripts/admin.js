...
form.addEventListener("submit", async (e) =>{
        ...
        //  ici ?= est un lockhead positif qui indique que dans le groupe à sa droite "il doit y avoir" et .* indique n'importe quel caractère répétée 0 ou plusieurs fois
